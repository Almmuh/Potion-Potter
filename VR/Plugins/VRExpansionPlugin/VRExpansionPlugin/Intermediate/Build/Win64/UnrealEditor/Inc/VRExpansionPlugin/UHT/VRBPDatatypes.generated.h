...
// IWYU pragma: private, include "VRBPDatatypes.h"
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_115_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_253_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_307_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_360_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_422_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_495_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_756_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_1077_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_1229_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_1265_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_1383_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_1642_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_1692_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_1774_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_1825_GENERATED_BODY \
...
#define FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h_1881_GENERATED_BODY \
...
#define CURRENT_FILE_ID FID_Users_Tyler_Nunes_Documents_GitHub_TheBestTeam_VR_Plugins_VRExpansionPlugin_VRExpansionPlugin_Source_VRExpansionPlugin_Public_VRBPDatatypes_h
...
#define FOREACH_ENUM_EVRCUSTOMMOVEMENTMODE(op) \
	...
	op(EVRCustomMovementMode::VRMOVE_SplineFollow) 

enum class EVRCustomMovementMode : uint8;
template<> struct TIsUEnumClass<EVRCustomMovementMode> { enum { Value = true }; };
...
#define FOREACH_ENUM_EVRCONJOINEDMOVEMENTMODES(op) \
	...
	op(EVRConjoinedMovementModes::C_VRMOVE_SplineFollow) \
	...
	op(EVRConjoinedMovementModes::C_VRMOVE_Custom7) \
	op(EVRConjoinedMovementModes::C_VRMOVE_Custom8) \
	op(EVRConjoinedMovementModes::C_VRMOVE_Custom9) \
	op(EVRConjoinedMovementModes::C_VRMOVE_Custom10) 

enum class EVRConjoinedMovementModes : uint8;
template<> struct TIsUEnumClass<EVRConjoinedMovementModes> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EBPVRResultSwitch> { enum { Value = true }; };
template<> VREXPANSIONPLUGIN_API UEnum* StaticEnum<EBPVRResultSwitch>();

#define FOREACH_ENUM_EVRCLIENTAUTHCONFLICTRESOLUTIONMODE(op) \
	op(EVRClientAuthConflictResolutionMode::VRGRIP_CONFLICT_None) \
	op(EVRClientAuthConflictResolutionMode::VRGRIP_CONFLICT_First) \
	op(EVRClientAuthConflictResolutionMode::VRGRIP_CONFLICT_Last) \
	op(EVRClientAuthConflictResolutionMode::VRGRIP_CONFLICT_DropAll) 

enum class EVRClientAuthConflictResolutionMode : uint8;
template<> struct TIsUEnumClass<EVRClientAuthConflictResolutionMode> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EBPVRWaistTrackingMode> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVRLerpInterpolationMode> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVRVelocityType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVRVectorQuantization> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EVRRotationQuantization> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EGripCollisionType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EBPHMDDeviceType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EGripLerpState> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<ESecondaryGripType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EGripLateUpdateSettings> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EGripMovementReplicationSettings> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EGripTargetType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EGripInterfaceTeleportBehavior> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EPhysicsGripConstraintType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EPhysicsGripCOMType> { enum { Value = true }; };
